...
public class StepDefinition {
	...
	public void user_should_enters(DataTable data)  {
		...
		driver.findElement(By.xpath("//*[contains(@name,'email') | @id='email']")).sendKeys(credentials.get("Username"));
		driver.findElement(By.xpath("//*[contains(@id,'passwd')]")).sendKeys(credentials.get("Password"));
